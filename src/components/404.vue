<template>
  <div class="http404-container">
    <div class="http404">
      ...
      <div class="errorPage">
        <div class="errorPage__oops">OOPS!</div>
        <div class="errorPage__headline">{{ message }}</div>
        <div class="errorPage__info">Please click the button below to return to the homepage.</div>
        <a href="" class="errorPage__return-home">HOME</a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    message() {
      return 'It seems that this page does not exist...'
    }
  }
}
</script>
